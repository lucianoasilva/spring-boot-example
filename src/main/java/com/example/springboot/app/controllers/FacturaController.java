...
public class FacturaController {
    ...
    public @ResponseBody List<Producto> cargarProductos(@PathVariable String term){
        //@ResponseBody: suprime el cargar una vista de Thymeleaf
                //va a tomar el resultado (lo retornado) convertido a json
                    //y eso lo va a poblar (registrar) dentro del body de la respuesta
    ...
    public String eliminar(@PathVariable(value = "id") Long id, RedirectAttributes flash){
        ...
        flash.addFlashAttribute("error", "La factura no pudo eliminarse porque no existe en la base de datos");
        return "redirect:/listar";
    }
}
